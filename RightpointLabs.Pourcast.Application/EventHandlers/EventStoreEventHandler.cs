namespace RightpointLabs.Pourcast.Application.EventHandlers
{
    ...
    public class EventStoreEventHandler<T> : IEventHandler<T> where T : IDomainEvent
    {
        ...
        public EventStoreEventHandler(IStoredEventRepository<T> storedEventRepository, IDateTimeProvider dateTimeProvider)
        {
        ...
        public void Handle(T domainEvent)
        {
            ...
            var storedEvent = new StoredEvent<T>(id, occuredOn, domainEvent);
